...
class App < Sinatra::Base
  ...
  post "/*" do 
    ...
    if File.exist?(path) || File.symlink?(path)
      status 404
      return "That file has already been uploaded: #{path}"
    end
  ...
  get "/*" do
    ...
    # Decrypt and put in the right place
    begin
      ...
      FileUtils.rm(decryption_temp, :force => true)
      FileUtils.rm(decryption_source, :force => true)
